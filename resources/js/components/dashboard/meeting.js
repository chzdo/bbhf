...
const tmpArgs = testTool.parseQuery();
 const signature = ZoomMtg.generateSignature({
    meetingNumber: '79725608185',
    apiKey: '2G6sVC0OTYoTaxhgiRXxVjzKFN2MkaH2KvmG',
    apiSecret: '4Q1mrHjx4RY97QPpiWAAUCOPNut2CyaVpfzP',
    role: tmpArgs.role,
...
hello
    ...
    if (document.getElementById('meeting')) {
        ...
        ReactDom.render(<VideoMeeting />, document.getElementById('meeting'));
    }